  ...
  var TodoList = /*#__PURE__*/function () {
    ...
    //   item.parents('li').toggleClass(CLASS_NAME_TODO_LIST_DONE);
      ...
      if (!$__default['default'](item).prop('checked')) {
        ...
        // item.parents('li').removeClass(CLASS_NAME_TODO_LIST_DONE);

        return;
      }

    //   item.parents('li').addClass(CLASS_NAME_TODO_LIST_DONE);
    ...
    //   $toggleSelector.find('input:checkbox:checked').parents('li').addClass(CLASS_NAME_TODO_LIST_DONE);

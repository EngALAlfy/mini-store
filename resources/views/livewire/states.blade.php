<div>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="d-flex card-tools">
                <button class="btn btn-success" data-toggle="modal" data-target="#add-state-modal" type="button"><i
                ...
                <table class="table table-striped projects table-responsive">
                    ...
                    <tbody>
                        @foreach ($states as $state)
                            <tr>
                                <td>
                                    <a href="{{ route('admin.states.show', $state) }}">#{{ $state->id }}</a>
                                </td>
                                <td>
                                ...
                                View
                                    ...
                                    @if ($delete_dialog)
                                        <button class="btn btn-danger btn-sm" data-target="#delete-modal"
                                            data-toggle="modal" wire:click="deleteId({{ $state->id }})">
        ...
        <div class="card-footer clearfix">
            <span class="float-left">{{ $states->links() }}</span>
    ...
    @livewire('create-state')

    @push('scripts')
        <script>
            Livewire.on('state_stored', () => {

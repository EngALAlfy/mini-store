<div class="form-group">
    ...
    <input wire:model="image" type="file" class="d-none" name="image" id="image" accept="image/*">


    <div id="input-zone" data-toggle="tooltip" title="@lang('all.choose_photo')" class="row justify-content-center m-0"
